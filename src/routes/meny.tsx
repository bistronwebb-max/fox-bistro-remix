  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { name: "Dubbel Ciao Ciao", desc: "Ost, fläskfilé, skinka, champinjoner, vitlök.", price: "140 kr" },
          { name: "Calzone Special", desc: "Ost, skinka, räkor.", price: "125 kr" },
          { name: "Calzone Vanlig", desc: "Ost, skinka.", price: "120 kr" },
        ],
      },
      {
        ...
        items: [
          { name: "Bagarens Special", desc: "Inbakade delen: ost, skinka. Andra halvan: mozzarella, lufttorkad skinka, kalamataoliver, salladsmix." },
          { name: "Florenzo", desc: "Mozzarella, pinjenötter, honung, chèvreost, crème fraîche, lufttorkad skinka, parmesanost." },
        ],
      },
      {
        title: "Klass A",
        ...
        items: [
          { name: "Vesuvio", desc: "Skinka." },
          { name: "Salamino", desc: "Salami." },
          { name: "Capricciosa", desc: "Skinka, champinjoner." },
          { name: "Hawaii", desc: "Skinka, ananas, ost." },
          { name: "Bolognese", desc: "Köttfärssås, lök." },
        ],
      },
      {
        title: "Klass B",
        ...
        items: [
          { name: "Orientale", desc: "Salami, lök, nötfärs, kalamataoliver." },
          { name: "Torino", desc: "Skinka, salami, bacon, ägg, lök." },
          { name: "Gorgonzola", desc: "Champinjoner, grillad paprika, lök, oliver, gorgonzola." },
          { name: "Värmland", desc: "Kyckling, banan, nötter, curry." },
          { name: "Quattro Stagioni", desc: "Skinka, champinjoner, räkor, musslor, kalamataoliver." },
          { name: "Maffia", desc: "Tonfisk, krabba, räkor, lök, chili, citron, peperoni (extra stark)." },
          { name: "Romeo", desc: "Skinka, ananas, banan, curry." },
        ],
      },
      {
        ...
        items: [
          { name: "Al Capone", desc: "Mozzarella, skinka, salami, bacon, champinjoner, paprika, tomatsås, salladsmix." },
          { name: "Inter", desc: "Mozzarella, lufttorkad skinka, soltorkade tomater, parmesanost, aubergine, salladsmix." },
          { name: "Macho", desc: "Mozzarella, lufttorkad skinka, cocktailtomater, pinjenötter, honung, chèvreost, salladsmix." },
          { name: "Paullos", desc: "Mozzarella, kyckling, bacon, stekta gröna sparris, vitlök, bearnaisesås." },
        ],
      },
      {
        ...
        note: "160 kr · Extra allt +30 kr · Familjepizza 360 kr.",
        items: [
          { name: "Black & White", desc: "Fläskfilé, oxfilé, kantareller, bearnaisesås, kebabsås." },
          { name: "Gourmet", desc: "Fläskfilé, skinka, ananas, räkor, stark bearnaisesås." },
          { name: "AC Milan", desc: "Fläskfilé, mozzarella, soltorkade tomater, paprika, lök, champinjoner, bearnaisesås, salladsmix." },
          { name: "Casablanca", desc: "Fläskfilé, oxfilé, stark tomatsås, champinjoner, bacon, lök, pressad vitlök, chilipeppar stark, bearnaisesås, salladsmix." },
        ],
      },
      {
        title: "Kebabpizzor",
        ...
        items: [
          { name: "Rävens Special", desc: "Karré, fläskfilé, bacon, champinjoner, räkor, lök, vitlök, cayennepeppar, sås." },
          { name: "Väse Special", desc: "Kebab, färsk sallad, sås." },
          { name: "Diablo", desc: "Kebab, salami, lök, jalapeño, tomater, peperoni, cayennepeppar, sås." },
          { name: "Tre Kronor", desc: "Kebab, skinka, pommes, sås." },
          { name: "Simon Special", desc: "Halvinbakad. Kebab, salami, lök, sås." },
        ],
      },
      {
        ...
        note: "160 kr · Extra allt +30 kr · Familjepizza 360 kr.",
        items: [
          { name: "Firondos", desc: "Fetaost, champinjoner, paprika, oliver, lök, soltorkade tomater, aubergine, jordnötter, salladsmix." },
          { name: "Formaggio", desc: "Oliver, fetaost, gorgonzola, chèvreost, parmesanost, mozzarella, salladsmix." },
        ],
      },
      {
        title: "Oxfilépizzor",
        note: "160 kr · Extra allt +30 kr · Familjepizza 360 kr.",
        items: [
          { name: "Sorprendente", desc: "Oxfilé, aubergine, zucchini, lök, cocktailtomater, kantareller, soltorkade tomater, bearnaisesås." },
          { name: "Excelente", desc: "Oxfilé, kyckling, räkor, tomat, vitlök, bearnaisesås." },
        ],
      },
      {
        ...
        note: "160 kr · Extra allt +30 kr · Familjepizza 360 kr.",
        items: [
          { name: "Acapulco", desc: "Stark tomatsås, oxfilé, lök, jalapeño, tacosås, vitlök, tacokrydda, cayenne." },
          { name: "Den onde", desc: "Oxfilé, champinjoner, lök, jalapeño, chipotlesås, cayenne, tacokrydda, bearnaisesås." },
          { name: "Mexicana", desc: "Köttfärssås, lök, jalapeño, chipotlesås, texmex, stark krydda." },
        ],
      },
      {
