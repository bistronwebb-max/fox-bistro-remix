  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { name: "Vesuvio", desc: "Ost, skinka." },
          { name: "Salamino", desc: "Ost, salami." },
          { name: "Capricciosa", desc: "Ost, skinka, champinjoner." },
          { name: "Hawaii", desc: "Skinka, ananas, ost." },
          { name: "Bolognese", desc: "Ost, köttfärssås, lök." },
        ],
      },
      {
        title: "Klass B",
        ...
        items: [
          { name: "Orientale", desc: "Ost, salami, lök, nötfärs, kalamataoliver." },
          { name: "Torino", desc: "Ost, skinka, salami, bacon, ägg, lök." },
          { name: "Gorgonzola", desc: "Champinjoner, grillad paprika, lök, oliver, gorgonzola." },
          { name: "Värmland", desc: "Ost, kyckling, banan, nötter, curry." },
          { name: "Quattro Stagioni", desc: "Ost, skinka, champinjoner, räkor, musslor, kalamataoliver." },
          { name: "Maffia", desc: "Ost, tonfisk, krabba, räkor, lök, chili, citron, peperoni (extra stark)." },
          { name: "Romeo", desc: "Ost, skinka, ananas, banan, curry." },
        ],
      },
      {
      ...
      },
      {
        ...
        note: "160 kr · Extra allt +30 kr · Familjepizza 360 kr.",
        items: [
          { name: "Black & White", desc: "Ost, fläskfilé, oxfilé, kantareller, bearnaisesås, kebabsås." },
          { name: "Gourmet", desc: "Ost, fläskfilé, skinka, ananas, räkor, stark bearnaisesås." },
          { name: "AC Milan", desc: "Fläskfilé, mozzarella, soltorkade tomater, paprika, lök, champinjoner, bearnaisesås, salladsmix." },
          { name: "Casablanca", desc: "Ost, fläskfilé, oxfilé, stark tomatsås, champinjoner, bacon, lök, pressad vitlök, chilipeppar stark, bearnaisesås, salladsmix." },
        ],
      },
      {
        title: "Kebabpizzor",
        ...
        items: [
          { name: "Rävens Special", desc: "Ost, karré, fläskfilé, bacon, champinjoner, räkor, lök, vitlök, cayennepeppar, sås." },
          { name: "Väse Special", desc: "Ost, kebab, färsk sallad, sås." },
          { name: "Diablo", desc: "Ost, kebab, salami, lök, jalapeño, tomater, peperoni, cayennepeppar, sås." },
          { name: "Tre Kronor", desc: "Ost, kebab, skinka, pommes, sås." },
          { name: "Simon Special", desc: "Halvinbakad. Ost, kebab, salami, lök, sås." },
        ],
      },
      {
