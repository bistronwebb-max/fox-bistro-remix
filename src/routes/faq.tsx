...
const faqs = [
  { q: "Hur bokar jag bord?", a: "Ring 054-18 18 20 — vi svarar direkt. För större sällskap och event, mejla boka@rävens.se. Öppet mån–tor 11–21, fre–lör 11–22 (till 01 vid evenemang), sön 11–21." },
  { q: "Var ligger ni?", a: "Storgatan 38, 660 57 Väse — strax utanför Karlstad. Lätt att parkera direkt utanför." },
  { q: "Serverar ni lunch?", a: "Ja, vardagar. Salladsbuffé, dryck och kaffe ingår, 139:- (pensionärsrabatt 14 kr). Veckans rätter publicerar vi löpande på vår Facebook-sida." },
  ...
  { q: "Kan vi boka catering?", a: "Absolut — mejla boka@rävens.se eller ring 054-18 18 20 så återkommer vi med förslag och pris. Vi cateror i hela Värmland." },
