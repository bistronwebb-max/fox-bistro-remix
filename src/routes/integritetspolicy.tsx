  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main id="content" className="flex-1 mx-auto max-w-3xl px-4 py-16 leading-relaxed">
        ...
        <p className="mt-2">Du har rätt att begära ut, rätta eller radera dina uppgifter. Mejla <a className="text-primary underline" href="mailto:kontakt@rävens.se">kontakt@rävens.se</a>.</p>
